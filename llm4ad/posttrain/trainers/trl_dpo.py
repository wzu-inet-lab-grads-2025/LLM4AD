...
class TrlDpoTrainer(TrainerBackendBase):
    def train(
    ...
    def _train_in_process(
        ...
        *,
        ...
        try:
            ...
            raise ImportError(
                "Posttrain DPO requires requirements-posttrain.txt dependencies."
            ) from exc
        ...
        ref_model = AutoModelForCausalLM.from_pretrained(train_config.base_model)
    ...
    def _train_via_subprocess(
        ...
        *,
        ...
        raise NotImplementedError(
            "Subprocess-based DPO training is reserved but not implemented yet."
        )
